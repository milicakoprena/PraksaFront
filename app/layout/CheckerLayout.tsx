import { computable, History, Instance } from 'cx/ui';
import {
   Dropdown,
...
export const CheckerLayout = ({ children }:CheckerLayoutProps) => (
   <cx>
      <div
         class="h-full grid grid-cols-2 grid-rows-2"
         styles="grid-template-columns: 250px 1fr; grid-template-rows: auto 1fr"
      ...
      >
         ...
         <div class="border-r pt-3">
            ...
            <NavItem text="Praksa" icon="information-circle" href="~/praksa" />
         </div>
         {children}
      </div>
   </cx>
